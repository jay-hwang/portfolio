...
const Connect = () => {
  return (
    <div className='social-links'>
      ...
      <a className='social-link' href='https://github.com/jay-ithiel' target='_blank'>
        <img
          alt='GitHub'
      ...
      <a className='social-link' href='https://angel.co/jay-ithiel' target='_blank'>
        <img
          alt=''
      ...
      <a className='social-link' href='https://www.linkedin.com/in/jay-ithiel' target='_blank'>
        <img
          alt=''
      ...
      <a className='social-link' href='mailto:jay.ithiel@gmail.com' target='_blank'>
        <img
          alt=''
